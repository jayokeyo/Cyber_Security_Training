'''Create an empty .py file. When the worm script is run
the content of the worm will be copied here'''
'''worm.py scans for all files within the given path
whose filenames end with infect_me.py and copies its script on them'''
import os
#import datetime
#import subprocess
